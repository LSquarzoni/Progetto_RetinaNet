...
im = cv2.imread("/home/lsquarzoni/work/RetinaNet/Im_samples/Im_fromGoogle/tavola.jpg") #path immagine

""" def detect(im, predictor):
    outputs = predictor(im)
    v = Visualizer(im[:, :, ::-1], bottle_tin_can_metadata, scale=1.5)
    out = v.draw_instance_predictions(outputs["instances"].to("cpu"))
    cv2.imwrite('/home/lsquarzoni/work/RetinaNet/Im_samples/Im_outputs/pred_OpenImages.jpg', out.get_image()[:, :, ::-1]) """

#Load model
cfg = get_cfg()
cfg.merge_from_file("/home/lsquarzoni/work/RetinaNet/Script_Python/retinanet_mnv2.yaml") #MNV2
cfg.MODEL.WEIGHTS = "/home/lsquarzoni/work/RetinaNet/OpenImagesV6_TinCan/outputTraining1_100k_LR5e-5_MNV2finale/model_final.pth"
cfg.DATASETS.TRAIN = ("Bottle_TinCan_train",)
...
v = Visualizer(im[:, :, ::-1], metadata=MetadataCatalog.get(cfg.DATASETS.TRAIN[0]), scale=0.7)
out = v.draw_instance_predictions(outputs["instances"].to("cpu"))
cv2.imwrite('/home/lsquarzoni/work/RetinaNet/Im_samples/Im_outputs_test/TESTONE.jpg', out.get_image()[:, :, ::-1])
